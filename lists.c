 ...
 * @head: Parameter for address of pointer to head node
 ...
 * @head: Parameter that address of pointer to first node
 ...
 * @head_ptr: Parameter for address of pointer to head node
 *
 * Return: void
 */
